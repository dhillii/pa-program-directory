...
const ProgramDetailModal: React.FC<ProgramDetailModalProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 right-0 z-50 w-full md:w-96 h-[90vh] md:h-screen bg-white shadow-2xl overflow-y-auto animate-in slide-in-from-bottom md:slide-in-from-right duration-500 ease-out">
